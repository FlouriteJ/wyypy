...
if os.path.exists('playlist_plus.db'):
	filePlaylist = open("playlist_plus.db",'r')
	for line in filePlaylist:
		hashPlaylist[line.strip('\n')] = True
	filePlaylist.close()

if os.path.exists('song_plus.db'):
	fileSong = open("song_plus.db",'r')
...
filePlaylist = open("playlist_plus.db",'a')
fileSong = open("song_plus.db",'a')
